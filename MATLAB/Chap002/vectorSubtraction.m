...
C = [2, 3] % 点C
Cvec = A - C; % A - C
quiver(C(1), C(2), Cvec(1), Cvec(2), 0, 'b', 'LineWidth', 2, 'MaxHeadSize', 0.45, 'Marker', 'o', 'MarkerSize', 5, 'MarkerFaceColor', 'b');
text(1.0, 3.0, '$C(2, 3)$', 'Interpreter', 'latex', 'FontSize', 14);
% ベクトルの加算
ACvec = Bvec + Cvec;
quiver(C(1), C(2), ACvec(1), ACvec(2), 0, 'g', 'LineWidth', 2, 'MaxHeadSize', 0.45, 'Marker', 'o', 'MarkerSize', 5, 'MarkerFaceColor', 'g');
